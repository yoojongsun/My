    ...
    function fn_egov_regist_notice() {
       ...
       for(var i=0; i<test1.length; i++){
      	...
      	if(count==5)
      	 ...
      	 if(document.board.bbs_DateStart.value>document.board.bbs_DateEnd.value)
         {
         	alert("날짜를 다시 설정해주세요");
         	return;
         }
            ...
            //document.board.onsubmit();
            document.board.action = "<c:url value='/cop/bbs/BbsInsert.do'/>";
                        ...
                        <table >
                            <tr>
						        ...
						        <td width="80%" nowrap colspan="3">
						          <input id="nttSj" name="bbs_Title" type="text" size="60" value=""  maxlength="60" required > 
						    ...
						    <tr> 
						        ...
						        <td colspan="3">
						          <textarea id="nttCn" name="bbs_Content" class="textarea" cols="75" rows="20" style="width:99%;" maxlength="500"></textarea> 
						 ...
						 <tr>
						 	<th width="20%" height="23" class="required_text"><label>
										게시판 속성
								</label> <img src="<c:url value='/images/required.gif' />" width="15"
									height="15" alt="required" /></th>
								<td width="30%" nowrap="nowrap">
									 <c:forEach  var="result" items="${propertyList}" varStatus="status">
									 <c:choose >
									 		<c:when test="${status.first }"> 
								      	     <input type="radio" name="Bbs_Radio" checked="checked" value="${result.codeNm}">${result.codeNm}
								           </c:when>
								           <c:otherwise>
								         	  <input type="radio" name="Bbs_Radio" value="${result.codeNm}">${result.codeNm}
								           </c:otherwise>
								        </c:choose> 
                               		</c:forEach>
						 	...
						 	<td>
					           ...
					           <select name="Bbs_Select" class="select" title="검색조건 선택">
							...
							<tr>
								...
								<td width="100%" nowrap="nowrap">
									...
									<c:forEach  var="result" items="${workList}" varStatus="status">
									 	<input type="checkbox" name="Bbs_Check" value="${result.codeNm}"> ${result.codeNm }
                               		</c:forEach>
								</td>
							...
							<tr>
								...
								<td width="100%" nowrap="nowrap">
									  ...
									  <input type="text" name="bbs_DateStart" id="datepicker1"> ~
									  <input type="text" name="bbs_DateEnd" id="datepicker2">

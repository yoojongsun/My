...
<script type="text/javascript">
	...
	function fn_egov_insert_addBrdMstr(){	
		document.frm.action = "<c:url value='/cop/bbs/BbsRegist.do'/>";
		document.frm.submit();
	}
	...
	function fn_egov_select_brdMstr(pageNo){
		...
		document.frm.action = "<c:url value='/cop/bbs/BbsList.do'/>";
		document.frm.submit();	
	}
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <!-- 검색 필드 박스 시작 -->
                <div id="search_field"> 
                    <div id="search_field_loc"><h2><strong>게시물 목록</strong></h2></div>
                            ...
                            <ul id="search_first_ul">
                                ...
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:182px;">
                                        <a href="#LINK" onclick="javascript:fn_egov_select_brdMstr(1); return false;"><img src="<c:url value='/images/img_search.gif' />" alt="search" />조회 </a>
                                        <% if(null != session.getAttribute("LoginVO")){ %>
                                        
                                            <a href="<c:url value='/cop/bbs${prefix}/BbsRegist.do'/>">등록</a>
                ...
                <div class="default_tablestyle">
                    ...
                    <tr>
                        ...
                        <th scope="col" nowrap="nowrap">게시물명</th>
                        <th scope="col" nowrap="nowrap">작성자</th>
                        <th scope="col" nowrap="nowrap">날짜</th>
                    ...
                    <!-- loop 시작 -->    
					 ...
					 <tr>
					    ...
					    <td nowrap="nowrap"><strong>${resultCnt-(Bbs.pageIndex-1)*10-status.index}</strong></td>		    
					    <td nowrap="nowrap">
					    	
					
			<a href="<c:url value='/cop/bbs/BbsInqire.do'/>?bbs_Idx=<c:out value='${result.bbs_Idx}'/>">
								<c:out value="${result.bbs_Title}"/>
							</a>
					    ...
					    <td nowrap="nowrap"><c:out value="${result.bbs_Name}"/></td>
					    <td nowrap="nowrap"><c:out value="${result.bbs_Date}"/></td>
					    <td nowrap="nowrap"><c:out value="${result.bbs_Hit}"/></td>

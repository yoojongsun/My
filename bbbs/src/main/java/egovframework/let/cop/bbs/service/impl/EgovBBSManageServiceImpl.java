...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
    ...
    public void updateBbsArticle(Bbs bbs) throws Exception {
    	bbsMngDAO.updateBbsArticle(bbs);
        }
	...
	@Override
	public Bbs BbsInqire(Bbs bbs) throws Exception {
		// TODO Auto-generated method stub
		bbsMngDAO.BbsHit(bbs);
		return bbsMngDAO.BbsInqire(bbs);
		
	}

	@Override
	public void BbsDelete(Bbs bbs) throws Exception {
		// TODO Auto-generated method stub
		bbsMngDAO.BbsCheck(bbs);
		bbsMngDAO.BbsDeleteFileDetail(bbs);
		bbsMngDAO.BbsDeleteFile(bbs);
		bbsMngDAO.BbsDelete(bbs);
	...
	@Override
	public Map<String, Object> BbsList(Bbs bbs) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

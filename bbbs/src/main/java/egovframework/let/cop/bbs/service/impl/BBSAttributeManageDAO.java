...
public class BBSAttributeManageDAO extends EgovAbstractDAO {
    ...
    @SuppressWarnings("unchecked")
    public List<Bbs> BbsList(Bbs bbs) throws Exception {
    	
	return (List<Bbs>) list("BBSAttributeManageDAO.BbsList", bbs);
    }
    
    public int BbsListCnt(Bbs bbs) throws Exception {
    	return (Integer)select("BBSAttributeManageDAO.BbsListCnt", bbs);
        }
    /**
	...
	public int BbsInsert(Bbs bbs) {
		...
		int idx=(int) insert("BBSAttributeManageDAO.BbsInsert",bbs);
		return idx;
		
	}
	public void BbsCheck(Bbs bbs) {
		// TODO Auto-generated method stub
		insert("BBSAttributeManageDAO.BbsCheck", bbs);
	}

	public void BbsUpdt(Bbs bbs) {
		// TODO Auto-generated method stub
		update("BBSAttributeManageDAO.BbsUpdt",bbs);
	}
	
	public void BbsCheckDelete(Bbs bbs) {
		// TODO Auto-generated method stub
		delete("BBSAttributeManageDAO.BbsCheckDelete",bbs);
	}

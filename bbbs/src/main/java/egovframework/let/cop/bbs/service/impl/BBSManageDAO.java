...
public class BBSManageDAO extends EgovAbstractDAO {
     ...
     * @throws Exception
     */
	public List<BbsCheck> BbsCheck(BbsCheck chk) throws Exception{
		return (List<BbsCheck>) list("BBSManageDAO.bbsCheck", chk);		
	}
    ...
    public void updateBbsArticle(Bbs bbs) throws Exception {
    	update("BBSManageDAO.updateBbsArticle", bbs);
        }
	...
	public Bbs BbsInqire(Bbs bbs) {
		// TODO Auto-generated method stub
		
		return (Bbs) select("BBSManageDAO.BbsInqire",bbs);
	}

	public void BbsHit(Bbs bbs) {
		// TODO Auto-generated method stub
		update("BBSManageDAO.BbsHit",bbs);
	}

	public void BbsDelete(Bbs bbs) {
		// TODO Auto-generated method stub
		delete("BBSManageDAO.BbsDelete",bbs);
	}
	
	public void BbsCheck(Bbs bbs) {
		// TODO Auto-generated method stub
		delete("BBSManageDAO.BbsCheck",bbs);
	}
	public void BbsDeleteFile(Bbs bbs) {
		// TODO Auto-generated method stub
		delete("BBSManageDAO.BbsDeleteFile",bbs);
	}
	public void BbsDeleteFileDetail(Bbs bbs) {
		// TODO Auto-generated method stub
		delete("BBSManageDAO.BbsDeleteFileDetail",bbs);
	}
}

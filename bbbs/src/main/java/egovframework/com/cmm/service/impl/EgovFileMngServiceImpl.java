...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
	...
	fileMngDAO.deleteFiles(fvoList);
    }
	...
	//Delete & Insert
	fileMngDAO.updateFiles(fvoList);
    }
	...
	public String insertFiles(List<?> fvoList) throws Exception {
		String atchFileId = "";
		System.out.println("여긴 임플이양");
		if (fvoList.size() != 0) {
			System.out.println("여긴 임플이양");
		    atchFileId = fileMngDAO.insertFiles(fvoList);
		    
		}
		if(atchFileId == ""){
			System.out.println("여긴 파일이없는데");
			atchFileId = null;
		}
		return atchFileId;
	}
	...
	@Override
	public List<BbsFile> selectFileLists(BbsFile fvo) throws Exception {
		return fileMngDAO.selectFileLists(fvo);
	...
	public BbsFile bbsFileInf(BbsFile fvo) throws Exception {
		...
		return fileMngDAO.bbsFileInf(fvo);
	}


	@Override
	public int getMaxFile(BbsFile fvo) throws Exception {
		return fileMngDAO.getMaxFile(fvo);
